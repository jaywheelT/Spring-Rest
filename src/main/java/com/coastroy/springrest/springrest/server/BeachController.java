...
import com.coastroy.springrest.springrest.server.handler.ErrorMessage;
...
public class BeachController {
  ...
  @RequestMapping(value = "/beaches/{id}/null", method = RequestMethod.POST)
  public ResponseEntity testBeach() {
    String a = null;
    a = a.concat("1");
